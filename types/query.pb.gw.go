...
var (
	pattern_Query_Supply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"AutonomyNetwork", "nft", "supplies", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Owner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"AutonomyNetwork", "nft", "owners", "owner"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"AutonomyNetwork", "nft", "collections", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"AutonomyNetwork", "nft", "denoms", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"AutonomyNetwork", "nft", "denoms"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"AutonomyNetwork", "nft", "nfts", "denom", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
